    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="glass-card rounded-3xl p-10 border-2">
        <div className="flex items-center gap-4 mb-3">
          ...
          <div>
            <h1 className="text-4xl font-bold" style={{ color: '#4F46E5' }}>My Dashboard</h1>
            <p className="mt-1" style={{ color: '#6366F1' }}>Track your contributions and achievements</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-card rounded-2xl p-6 border group">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-xl glass-card flex items-center justify-center border">
              <UploadIcon className="w-7 h-7" style={{ color: '#6366F1' }} />
            </div>
            <div>
              <div className="text-3xl font-bold" style={{ color: '#4F46E5' }}>{stats.totalUploads}</div>
              <div className="text-sm font-medium" style={{ color: '#818CF8' }}>Total Uploads</div>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card rounded-2xl p-6 border group">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-xl glass-card flex items-center justify-center border">
              <Download className="w-7 h-7" style={{ color: '#6366F1' }} />
            </div>
            <div>
              <div className="text-3xl font-bold" style={{ color: '#4F46E5' }}>{stats.totalDownloads}</div>
              <div className="text-sm font-medium" style={{ color: '#818CF8' }}>Total Downloads</div>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card rounded-2xl p-6 border group">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-xl glass-card flex items-center justify-center border">
              <CheckCircle className="w-7 h-7" style={{ color: '#6366F1' }} />
            </div>
            <div>
              <div className="text-3xl font-bold" style={{ color: '#4F46E5' }}>{stats.approvedPapers}</div>
              <div className="text-sm font-medium" style={{ color: '#818CF8' }}>Approved Papers</div>
            </div>
          </div>
        </div>
      </div>
      ...
      {badges.length > 0 && (
        <div className="glass-card rounded-2xl p-8 border">
          <h2 className="text-2xl font-bold mb-6 flex items-center gap-3" style={{ color: '#4F46E5' }}>
            ...
            {badges.map(b => {
              ...
              return (
                <div key={b} className="glass-card rounded-xl p-4 border text-center group hover:scale-105 transition-transform">
                  ...
                  <div className="text-sm font-bold" style={{ color: '#4F46E5' }}>{b.replace(/_/g, ' ')}</div>
                </div>
              )
            })}
          </div>
      ...
      <div className="glass-card rounded-2xl p-8 border">
        ...
        {items.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="font-medium" style={{ color: '#6366F1' }}>No papers uploaded yet</p>
            <p className="text-sm mt-2" style={{ color: '#818CF8' }}>Start contributing to earn badges!</p>
          </div>
        ) : (
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-4 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-bold truncate" style={{ color: '#4F46E5' }}>{i.subject}</div>
                      <div className="text-sm" style={{ color: '#818CF8' }}>{i.department} • {i.year}</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 flex-shrink-0">
                    ...
                    <div className="text-sm font-medium flex items-center gap-1" style={{ color: '#818CF8' }}>
